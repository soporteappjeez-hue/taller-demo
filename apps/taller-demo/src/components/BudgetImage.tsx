...
const EMPRESA = {
  nombre: "AppJeez",
  slogan: "Demo para Service Tecnicos",
  cuit:   "20-31264840-8",
...
const CLAUSULA_90 =
  "Transcurridos los 90 días del aviso de retiro, la unidad se considerará en abandono, facultando al local a proceder a su venta para cubrir gastos de almacenaje y reparación según los Art. 2525 y 2526 del Código Civil y Comercial de la Nación (Ley de Depósito).";
...
export default function BudgetImage({ order, onClose }: Props) {
  ...
  const sendWhatsApp = () => {
    const text = encodeURIComponent(
      ...
      `*AppJeez — Demo para Service Tecnicos*`
    );
        ...
        >
          ...
          <div style={{ background: "linear-gradient(135deg,#1a3a5c 0%,#0f2540 100%)", padding: "28px 36px 24px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <img src="/logo-maqjeez.png" alt="AppJeez" style={{ height: 72, width: "auto", objectFit: "contain" }} />
              </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, padding: "24px 36px 0", marginTop: 16 }}>
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 700, color: "#1a3a5c" }}>AppJeez</div>
              <div style={{ fontSize: 11, color: "#64748b" }}>Firma y sello del local</div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ borderBottom: "2px solid #1a3a5c", height: 48, marginBottom: 8 }} />
