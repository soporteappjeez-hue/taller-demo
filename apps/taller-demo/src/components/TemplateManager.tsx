...
const DEFAULT_TEMPLATES: Omit<PlantillaWhatsApp, "id" | "createdAt">[] = [
  {
    ...
    message: "Hola {{nombre}}, te informamos que el presupuesto para tu {{marca}} {{modelo}} ({{motor}}) está listo. Por favor comunicate con nosotros para confirmarlo. ¡Gracias por confiar en AppJeez!",
  },
  {
    name: "Equipo listo para retiro",
    message: "Hola {{nombre}}, tu {{marca}} {{modelo}} ({{motor}}) ya está lista para ser retirada. Te esperamos en el local. ¡Gracias!",
  },
  {
    name: "Recordatorio de retiro",
    message: "Hola {{nombre}}, te recordamos que tu {{marca}} {{modelo}} ({{motor}}) sigue esperando ser retirada en nuestro local. Comunicate con nosotros para coordinar la entrega.",
  },
];
